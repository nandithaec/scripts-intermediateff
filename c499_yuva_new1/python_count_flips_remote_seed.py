...
#Example usage: python python_count_flips_remote_seed.py -f /home/external/iitb/nanditha/simulations/c499_ecat_yuva_ip_FF  -n 5 --group 5 -s 4432444938972988881
