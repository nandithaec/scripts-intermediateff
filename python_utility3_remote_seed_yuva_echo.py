...
#Example usage: python /home/external/iitb/nanditha/simulations/c499_PNN/python_utility3_remote_seed_yuva.py -m c499_clk_opFF -p /home/external/iitb/nanditha/simulations/FF_optimisation/c499_PNN -d c499_PNN -t 180 -n 10 --group 10 --clk 300 --std_lib osu018_stdcells_correct_vdd_gnd.sp
...
#This means, glitch "can" occur before the input changes in the clk period as well. So, force the glitch to start only after input has changed
		...
		rand_glitch= (4.67*clk_period) +  unif #arrival_clk + initial_clk should add up to 4.5+0.1=4.6. 1 period-0.1=0.9
