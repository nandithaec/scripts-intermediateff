...
#Example usage: python utility_python_top_level_echo.py --rtl=/home/users/nanditha/Documents/utility/c499_PNN/c499_clk_opFF.v --mod=c499_clk_opFF --test=/home/users/nanditha/Documents/utility/c499_PNN/test_c499.v --tb_mod=test_c499 --clk=100 --run=100us --design=c499_PNN --tech=180 --num=10 --group 10 --path=/home/user1/simulations/c499_PNN  --std_lib osu018_stdcells_correct_vdd_gnd.sp
...
"""
#Executing jobscript remotely on the pune cdac server machine
#os.system('ssh nanditha@yuva.cdac.in qsub %s/jobscript.txt' %(path_folder))
