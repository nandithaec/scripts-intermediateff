...
#Example usage: python utility_python_top_level_echo_cascading.py --rtl=/home/users/nanditha/Documents/utility/FF_optimisation/c432_priority_opFF/c432_clk_opFF.v --mod=c432_clk_opFF --idelay 1.1 --odelay 1.1 --ipff iDFF --opff oDFF --test=/home/users/nanditha/Documents/utility/FF_optimisation/c432_priority_opFF/test_c432.v --tb_mod=test_c432 --clk=150 --run=100us --design=c432_priority_opFF --tech=180 --num=10 --group 10 --path=/home/external/iitb/nanditha/simulations/FF_optimisation/c432_priority_opFF  --std_lib osu018_stdcells_correct_vdd_gnd.sp  --proc_node 1 --ppn 10 --days 00 --hrs 00 --mins 10 --script python_utility3_yuva_echo_wt_5cycles.py
...
os.system('perl modperl2_outwrtr_new_cascading.pl -v pnr/op_data/%s_final.v -m %s' %(module,module))
...
os.system('perl NetlstFrmt_echo_5_cascading.pl -v %s_modelsim.v  -s %s.dspf -l glitch_%s -c %s -t %s -m %s' %(module,module,std_lib,clkfreq,techn, module))
