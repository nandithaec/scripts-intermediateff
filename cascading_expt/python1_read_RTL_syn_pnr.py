...
#Example usage: python python1_read_RTL_syn_pnr.py -f /home/users/nanditha/Documents/utility/c499_PNN/c499_clk_opFF.v -m c499_clk_opFF -c 100 --idelay 1.1 --odelay 0.7 --ipff iDFF --opff oDFF
